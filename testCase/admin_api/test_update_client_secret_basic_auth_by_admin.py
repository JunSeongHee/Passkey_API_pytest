...
def update_basic_auto_client_secret_api(
    base_url: str,
    ...
    url = f"{base_url}/admin/v1/clients/{client_id}/secret"
    if space_yes:
        headers = {
...
def update_basic_auto_client_secret_no_clientid_api(
    base_url: str,
    admin_encoded_credentials,
    method: str = "PATCH",
    ...
    url = f"{base_url}/admin/v1/clients//secret"
    if space_yes:
        headers = {
            'Authorization': f'Basic{admin_encoded_credentials}',
...
def response_assertion(self, response_code:str, response_text:str):
    ...
    try:
        ...
        assert "clientSecret" in client and isinstance(client["clientSecret"], str) and client["clientSecret"].strip(), "clientSecret 필수 및 빈 값 불가"
...
class Test_update_basic_auto_client_secret:
    ...
    no_exist_clientId = client_name = readConfig.getValue('Admin Info', 'no_exist_clientId')
    # admin 권한 base64 인코딩
    ...
    def test_update_basic_auto_client_secret_001(self):
        self.logger.info("#001 Client Secret 업데이트 (변경)")
        ...
        response_code, response_text = update_basic_auto_client_secret_api(
            self.bUrl,
    ...
    def test_update_basic_auto_client_secret_002(self):
        self.logger.info("#002 client id - 필수 파라미터 누락")

        response_code, response_text = update_basic_auto_client_secret_no_clientid_api(
            self.bUrl,
            self.admin_encoded_credentials
        )
    ...
    def test_update_basic_auto_client_secret_003(self):
    ...
    def test_update_basic_auto_client_secret_004(self):
    ...
    def test_update_basic_auto_client_secret_005(self):
    ...
    def test_update_basic_auto_client_secret_006(self):
    ...
    def test_update_basic_auto_client_secret_007(self):
    ...
    def test_update_basic_auto_client_secret_008(self):
        self.logger.info("#008 DELETE 요청")
    ...
    def test_update_basic_auto_client_secret_009(self):
    ...
    def test_update_basic_auto_client_secret_010(self):
    ...
    def test_update_basic_auto_client_secret_011(self):
        self.logger.info("#011 Client 권한 : admin 아닌 권한 - passkey:rp")

        if not controlClient.get_clientid_api(self.bUrl, self.admin_encoded_credentials, self.rpId) == 200:
            controlClient.create_client_api(self.bUrl, self.admin_encoded_credentials, self.rpId, self.client_name, self.rp_scope)
    ...
    def test_update_basic_auto_client_secret_012(self):
        self.logger.info("#012 Client 권한 : admin 아닌 권한 - passkey:rp:migration")
    ...
    def test_update_basic_auto_client_secret_013(self):
        self.logger.info("#013 Client 권한 : admin 아닌 권한 - passkey:rp, passkey:rp:migration")
    ...
    def test_update_basic_auto_client_secret_014(self):
    ...
    def test_update_basic_auto_client_secret_015(self):
    ...
    def test_update_basic_auto_client_secret_016(self):
